...
public class outputFile {
	...
	public outputFile() {
		if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
			...
			String dirPath = sdCardDir.getPath() + "/DetectorService/" + "Data" + TimeUtil.getTime_name(current_time);
			...
			dir = new File(temp + "/DetectorService/" + "Data" + TimeUtil.getTime_name(current_time));
		}
