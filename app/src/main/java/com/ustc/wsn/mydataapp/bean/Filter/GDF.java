...
public class GDF {
// Definitions
    private final float betaDef = 0.5f;        // 2 * proportional gain
    ...
    public void Filter(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz,float dt) {
        float recipNorm;
        float s0, s1, s2, s3;
