...
public class TimeUtil {
	...
	public static String getTime_name(long millis) {
		...
		return String.valueOf(c.get(Calendar.YEAR)) + "_" + String.valueOf(c.get(Calendar.MONTH) + 1) + "_"
				+ String.valueOf(c.get(Calendar.DAY_OF_MONTH)) + "_" + String.valueOf(c.get(Calendar.HOUR_OF_DAY)) + "_"
	 ...
	 *
	 * @param field
	 *            鏃堕棿鍩�,骞达紝鏈堬紝鏃ワ紝 灏忔椂锛屽垎閽燂紝绉掞紝寰
	 * @param type
	 *            1: year; 2: month, day, hour, minute, second; 3:millis
	 * @return
	 */
